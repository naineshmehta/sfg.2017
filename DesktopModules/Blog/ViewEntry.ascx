...
<script type="text/javascript">stLight.options({publisher: "7defe173-7c9b-4e05-9c8d-d0ca1fd78606", doNotHash: true, doNotCopy: true, hashAddressBar: false});</script>
 
<span class='st_fblike_hcount' displayText='Facebook Like'></span>
<span class='st_twitter_hcount' displayText='Tweet'></span>
<span class='st_plusone_hcount' displayText='Google +1'></span>
<br/><br/>
 <!--script src="http://connect.facebook.net/en_US/all.js#appId=139262759485951&amp;xfbml=1"></script>
 <fb:like id="fbLike" href="" send="true" layout="standard" width="450" show_faces="false" font="verdana"></fb:like>
    <div class="blog_twitter">
        <a href="http://twitter.com/share" class="twitter-share-button" data-count="horizontal" data-via="UKFestivalGuide">Tweet</a>
        <script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
    </div>
    <script language="javascript" type="text/javascript">
        var currentURL = location.href;
        //jQuery(document).ready(function() { jQuery('#fbComments').attr('href', currentURL); });
        jQuery(document).ready(function() { jQuery('#fbLike').attr('href', currentURL); });
    </script-->
 ...
 <fb:comments id="fbComments" href="" num_posts="3" width="650" migrated="1"></fb:comments-->

 <!-- Comments Section -->
<asp:Panel ID="pnlCommentsModule" runat="server" Visible="false">
