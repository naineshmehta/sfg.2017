...
<div id="dnnEditEntry" class="dnnForm dnnEditEntry dnnClear">
    ...
    <h2 id="dnnPanel-h2FileUpload" class="dnnFormSectionHead"><a href="" class="dnnLabelExpanded"><%= Me.GetLocalizedString("lblFileUpload.Text")%></a></h2>
        ...
        <ol id="olFileUpload" class="dnnmedia-list">
            ...
            <li id="liFileSystem" class="dnnmedia-listitem dnnmedia-localfiles" runat="server">
                ...
                <div class="dnnmedia-fieldwrapper">
                    <div class="dnnFormMessage dnnFormWarning"><%=Me.GetLocalizedString("lblUploadWarning.Text")%></div>
                </div>
            </li>
            <li id="liEmbed" class="dnnmedia-listitem dnnmedia-embed" runat="server">
                ...
                <div class="dnnmedia-fieldwrapper">
                    <div class="dnnFormMessage dnnFormInfo"><%=Me.GetLocalizedString("lblEmbedSupport.Text")%></div>
                </div>
            </li>
            <li id="liOEmbed" class="dnnmedia-listitem dnnmedia-oembed" runat="server">
                ...
                <div class="dnnmedia-fieldwrapper">
                    <div class="dnnFormMessage dnnFormInfo"><%=Me.GetLocalizedString("lblOEmbedSupport.Text")%></div>
                </div>
            </li>
        </ol>
    </fieldset>
    <h2 id="dnnPanel-h2Settings" class="dnnFormSectionHead"><a href="" class=""><%= Me.GetLocalizedString("BasicSettings.Text")%></a></h2>
    <fieldset id="fsSettings" class="dnnmedia-fieldset">
        <ol id="olSettings" class="dnnmedia-list">
            ...
            <li class="dnnmedia-listitem">
                <p class="Normal dnnmedia-form-message"><%=Me.GetLocalizedString("VideoDimsRequired.Text")%></p>
            </li>
            <li class="dnnmedia-listitem">
                <div class="dnnFormItem">
            ...
            <li class="dnnmedia-listitem">
                <div class="dnnFormItem">
                    ...
                    <div id="divMessageWrapper" class="dnnLeft">
    ...
    <h2 id="dnnPanel-h2VideoSettings" class="dnnFormSectionHead"><a href="" class=""><%= Me.GetLocalizedString("lblVideosOnly.Text")%></a></h2>
    <fieldset id="fsVideoSettings" class="dnnmedia-fieldset">
        <ol id="olVideoSettings" class="dnnmedia-list">
            <li class="dnnmedia-listitem">
                <div class="dnnFormMessage dnnFormWarning"><%=Me.GetLocalizedString("lblVideoMessage.Text")%></div>
            </li>
            <li class="dnnmedia-listitem">
                <div class="dnnFormItem">
    ...
    <h2 id="dnnPanel-h2ImageSettings" class="dnnFormSectionHead"><a href="" class=""><%= Me.GetLocalizedString("lblImagesOnly.Text")%></a></h2>
    ...
    <div id="divMediaCommands">
        <ul id="ulMediaCommands">
            ...
            <li class="dnnmedia-cmd-listitem">
                <asp:LinkButton class="dnnSecondaryAction" id="cmdCancel" resourcekey="cmdCancel" runat="server" borderstyle="none" text="Cancel" causesvalidation="False" />
            </li>
        </ul>
    </div>
</div>
<div id="divDnnAudit" class="dnnssStat dnnClear">
    ...
    <div id="divLastUpdated" class="dnnmedia-audit dnnClear">
        <span class="SubHead"><%= Me.LastUpdated%></span>
    </div>
</div>
...
(function ($, Sys) {
    function setupDnnSiteSettings() {
        ...
        $('#lnkViewFileTypes').live('click', function () { $('#divSupportedFileTypes').toggle(); return false; });
    }
