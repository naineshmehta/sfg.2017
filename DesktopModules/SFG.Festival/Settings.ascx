<%@ Control Language="C#" AutoEventWireup="false" Inherits="SFG.Modules.Festival.Settings" Codebehind="Settings.ascx.cs" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="Festival Settings Design Table">
    <tr>
