...
<div id="DNN6">
    ...
    <div id="Header">
	    ...
	    <div id="AdSlot">
			<script id="mNCC" language="javascript">  medianet_width='728';  medianet_height= '90';  medianet_crid='125723319';  </script>  <script id="mNSC" src="http://contextual.media.net/nmedianet.js?cid=8CU9X6J67" language="javascript"></script>  
	    </div>
	</div>
	<div id="MenuBar">
	    <div id="SearchPanel">
    ...
    <div id="Footer" class="footerback">
        <div id="FooterText">
            <ul>
                <li><asp:HyperLink ID="HyperLink1" NavigateUrl="~/Event-Calendar.aspx" Text="Event Calendar" runat="server"></asp:HyperLink></li>
				<li>|</li>
				...
				<li>|</li>
                <li><asp:HyperLink ID="HyperLink4" NavigateUrl="~/Jobs-at-Summer-Festival-Guide.aspx" Text="Jobs / Vacancies" runat="server"></asp:HyperLink></li>                    
				<li>|</li>
                <li><asp:HyperLink ID="HyperLink5" NavigateUrl="~/Festival-News.aspx" Text="Latest Festival News" runat="server"></asp:HyperLink></li>
				<li>|</li>
				<li><asp:HyperLink ID="HyperLink6" NavigateUrl="~/Who-are-we.aspx" Text="Who Are We" runat="server"></asp:HyperLink></li>
            </ul>
...
<dnn:DnnJsInclude runat="server" FilePath="s3Slider.js" PathNameAlias="SkinPath" />
<dnn:DnnJsInclude runat="server" FilePath="cookiecontrol.js" PathNameAlias="SkinPath" />
